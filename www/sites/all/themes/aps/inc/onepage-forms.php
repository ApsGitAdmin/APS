...
//One page regions
    ...
    $form['IMsettings']['onepage']['region1']['region1Name'] = array(
        '#type' => 'textfield',
        '#title' => t("Page title"),
        '#default_value' => theme_get_setting('region1Name', 'aps'),
    );
    $form['IMsettings']['onepage']['region1']['region1Description'] = array(
        '#type' => 'textarea',
        '#title' => t("Page description"),
        '#default_value' => theme_get_setting('region1Description', 'aps'),
        '#format' => 'full_html', 
    );
    ...
    $form['IMsettings']['onepage']['region2']['region2Name'] = array(
        '#type' => 'textfield',
        '#title' => t("Page title"),
        '#default_value' => theme_get_setting('region2Name', 'aps'),
    );
    $form['IMsettings']['onepage']['region2']['region2Description'] = array(
        '#type' => 'textarea',
        '#title' => t("Page description"),
        '#default_value' => theme_get_setting('region2Description', 'aps'),
        '#format' => 'full_html', 
    );
    ...
    $form['IMsettings']['onepage']['region3']['region3Name'] = array(
        '#type' => 'textfield',
        '#title' => t("Page title"),
        '#default_value' => theme_get_setting('region3Name', 'aps'),
    );
    $form['IMsettings']['onepage']['region3']['region3Description'] = array(
        '#type' => 'textarea',
        '#title' => t("Page description"),
        '#default_value' => theme_get_setting('region3Description', 'aps'),
        '#format' => 'full_html', 
    );
    ...
    $form['IMsettings']['onepage']['region4']['region4Name'] = array(
        '#type' => 'textfield',
        '#title' => t("Page title"),
        '#default_value' => theme_get_setting('region4Name', 'aps'),
    );
    $form['IMsettings']['onepage']['region4']['region4Description'] = array(
        '#type' => 'textarea',
        '#title' => t("Page description"),
        '#default_value' => theme_get_setting('region4Description', 'aps'),
        '#format' => 'full_html', 
    );
    ...
    $form['IMsettings']['onepage']['region5']['region5Name'] = array(
        '#type' => 'textfield',
        '#title' => t("Page title"),
        '#default_value' => theme_get_setting('region5Name', 'aps'),
    );
    $form['IMsettings']['onepage']['region5']['region5Description'] = array(
        '#type' => 'textarea',
        '#title' => t("Page description"),
        '#default_value' => theme_get_setting('region5Description', 'aps'),
        '#format' => 'full_html', 
    );
