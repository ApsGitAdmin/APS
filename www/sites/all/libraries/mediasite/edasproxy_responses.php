...
class QueryTotalViewsResponse {
    ...
    /**
     * @var array $ViewsList of {@link IdNameTotalPair}
     */
    public $ViewsList;
...
class QueryResults {
    ...
    /**
     * @var boolean $MoreResultsAvailable
     */
    public $MoreResultsAvailable;

    /**
     * @var QueryOptions $NextQueryOptions
     */
...
class QueryDatesWatchedResponse {
    ...
    /**
     * @var array $DatesWatchedList array of date/time formatted strings
     */
...
class PlatformUsage {
    ...
    /**
     * @var array $BrowserList of {@link IdNameTotalPair}
     */
    public $BrowserList;

    /**
     * @var array $MediaPluginList of {@link IdNameTotalPair}
     */
    public $MediaPluginList;

    /**
     * @var array $PlayerEngineList of {@link IdNameTotalPair}
     */
    public $PlayerEngineList;

    /**
     * @var array $SystemList of {@link IdNameTotalPair}
     */
    public $SystemList;
...
class QueryPresentationUsageResponse {
    ...
    /**
     * @var array $UsageList of {@link PresentationUsage}
     */
    public $UsageList;
...
class QueryActivePresentationsResponse {
    ...
    /**
     * @var array $ActivePresentationList of {@link IdNameTotalPair}
     */
...
class QueryActivePresentationConnectionsResponse {
    ...
    /**
     * @var ArrayofActiveConnection $ConnectionsList of {@link ActiveConnection}
     */
...
class PresentationDetails {
    ...
    /**
     * @var array $Content array of {@link PresentationContentDetails}
     */
    public $Content;
    ...
    /**
     * @var array $Presenters of {@link PresenterName}
     */
    public $Presenters;
...
class ContentServerDetails {
    ...
    /**
     * @var array $ServerConnections of {@link ContentServerEndpoint}
     */
 ...
 * @referenceonly This class provided for reference only, client applications should never need to instantiate this class
 */
class ContentServerDistributionEndpoint {
 ...
 * @referenceonly This class provided for reference only, client applications should never need to instantiate this class
 */
class ContentServerStorageEndpoint {
...
class ExternalLinkContentDetails {
    ...
    /**
     * @var array $ExternalLinks of {@link ExternalLinkDetails}
     */
...
class QueryCatalogSharesResponse {
    ...
    /**
     * @var array $Shares of {@link CatalogShare}
     */
    public $Shares;
...
class QueryChapterPointsResponse {
    ...
    /**
     * @var array $ChapterPoints of {@link ChapterDetails}
     */
...
class QueryContentServersByCriteriaResponse {
    ...
    /**
     * @var array $ContentServers of {@link ContentServerDetails}
     */
...
class QueryFoldersByIdResponse {
    ...
    /**
     * @var array $FolderDetails of {@link FolderDetails}
     */
...
class QueryFoldersWithPresentationsResponse {
    ...
    /**
     * @var array $Folders of {@link FolderDetails}
     */
    public $Folders;
...
class QueryContentEncodingSettingsByIdResponse {
    ...
    /**
     * @var array $ContentEncodingSettings of {@link ContentEncodingSettingDetails}
     */
...
class ContentEncodingSettingDetails {
    ...
    /**
     * @var array $H264StreamDescriptions of {@link EncodingStreamDescription}
     */
    public $H264StreamDescriptions;

    /**
     * @var array $H264StreamFilters of {@link EncodingSettingsFilter}
     */
...
class QueryPlayersResponse {
    ...
    /**
     * @var array $Players of {@link PlayerDetails}
     */
    public $Players;
...
class QueryPresentationsByIdResponse {
    ...
    /**
     * @var array $Presentations of {@link PresentationDetails}
     */
...
class QueryPresentationTemplatesByCriteriaResponse {
    ...
    /**
     * @var array $PresentationTemplates of {@link PresentationTemplateDetails}
     */
...
class PresentationTemplateDetails {
    ...
    /**
     * @var array $ContentDetails of {@link PresentationTemplateContentDetails}
     */
...
class QueryPresentersByCriteriaResponse {
    ...
    /**
     * @var array $Presenters of {@link PresenterDetails}
     */
    public $Presenters;
...
class QueryPresentersByIdResponse {
    ...
    /**
     * @var array $PresenterDetails of {@link PresenterDetails}
     */
...
class ResourcePermissionDetails {
    ...
    /**
     * @var array $PermissionList of {@link ResourcePermissionEntry}
     */
...
class QueryResourcePermissionsResponse {
    ...
    /**
     * @var array $ResourceList of {@link ResourcePermissions}
     */
    public $ResourceList;
...
class QuerySchedulesByCriteriaResponse {
    ...
    /**
     * @var array $ScheduleList of {@link ScheduleDetails}
     */
    public $ScheduleList;
...
class ScheduleDetails {
    ...
    /**
     * @var array $ContentDetails of {@link ScheduleContentDetails}
     */
    public $ContentDetails;
...
class QuerySlidesResponse {
    ...
    /**
     * @var array $Slides of {@link SlideDetails}
     */
    public $Slides;
...
class QueryTimeZonesByCriteriaResponse {
    ...
    /**
     * @var array $TimeZones of {@link MediasiteTimeZone}
     */
    public $TimeZones;
...
class SearchResponse {
    ...
    /**
     * @var array $DetailList of {@link SearchResponseDetails}
     */
    public $DetailList;
...
class QueryRolesByIdResponse {
    ...
    /**
     * @var array $RoleDetails of {@link MediasiteRoleDetails}
     */
    public $RoleDetails;
